  ...
  <ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab"
        aria-controls="home" aria-selected="true">Agregar</button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab"
        aria-controls="profile" aria-selected="false">Lista</button>
    </li>
      ...
      <form id="registro-venta">
        ...
        <div class="row">
          ...
          <div class="form-group col">
            ...
            <input type="number" class="form-control" id="txtnumero" name="txtnumero" aria-describedby="emailHelp">
          </div>
        ...
        <div class="row">
          ...
          <div class="form-group col">
            ...
            <input type="number" class="form-control" id="txttotal" name="txttotal" aria-describedby="emailHelp">
          </div>
          <div class="form-group col " hidden>
            <label for="exampleInputEmail1" >Usuario</label>
            <input type="number" class="form-control" id="txtusuario" name="txtnumero" aria-describedby="emailHelp" value="1">
          </div>
