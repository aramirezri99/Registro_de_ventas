...
<div class="modal fade" id="modal-edit-venta" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
              ...
              <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="idventa-medit" name="txtcantidad" aria-describedby="emailHelp">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="serie-medit" name="txtcantidad" aria-describedby="emailHelp">
                </div>
